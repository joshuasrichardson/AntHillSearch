...
SETTING_KEYS = [CONVERGENCE_FRACTION_NAME, USE_ROUNDS_AS_DURATION_NAME, SIM_DURATION_NAME, FLOOD_ZONE_COVERAGE_NAME,
                FLOOD_ZONE_CORNERS_NAME, FONT_SIZE_NAME, LARGE_FONT_SIZE_NAME, NUM_HUBS_NAME,
                ...
                NUM_PREDATORS_NAME, PRED_POSITIONS_NAME, NUM_LADYBUGS_NAME, LADYBUG_POSITIONS_NAME, FULL_CONTROL_NAME,
                DISTRACTED_NAME]
