...
from display import SiteDisplay, Display
...
class RecordingPlayer(AbstractColonySimulation):
    ...
    def __init__(self):
        Display.shouldDraw = True
        SiteDisplay.knowSitePosAtStart = True
        super().__init__(useRestAPI=False, shouldRecord=False)
    ...
    def initializeWorld(self, numSites, hubLocation, hubRadius, hubAgentCount, sitePositions, siteQualities,
        ...
        world = World(numSites, hubLocation, hubRadius, self.recorder.getNumAgents(), sitePositions,
                      siteQualities, siteRadii, siteNoCloserThan, siteNoFartherThan, False)
